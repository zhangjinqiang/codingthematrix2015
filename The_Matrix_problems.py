...
def lin_comb_vec_mat_mult(v, M):
    ...
    result = Vec(M.D[1], {})
    for r,value in rowdict.items():
        result = result + v[r] * value
    return result
